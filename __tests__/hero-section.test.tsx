...
describe("HeroSection CTA hierarchy", () => {
  it("keeps Let's talk first, then CV + GitHub + LinkedIn in the same action row", () => {
    render(<HeroSection />);
    ...
    expect(primaryLinks[1]).toHaveTextContent(UI_LABELS.hero.downloadCv);
    expect(primaryLinks[1]).toHaveAttribute("href", HERO_CTA.cv);
