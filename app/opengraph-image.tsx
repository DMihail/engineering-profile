      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 24, marginBottom: 40 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ fontSize: 18, color: "#22C55E", fontFamily: "monospace", letterSpacing: "0.06em" }}>
              OPEN TO CONTRACTS
            </span>
          </div>
        </div>

        <div style={{ fontSize: 64, fontWeight: 800, color: "#E5E7EB", letterSpacing: "-0.03em", lineHeight: 1.05, marginBottom: 12 }}>
          {SITE_AUTHOR}
        </div>

        <div style={{ fontSize: 28, fontWeight: 600, color: "#38BDF8", letterSpacing: "-0.01em", marginBottom: 24 }}>
          {SITE_ROLE}
        </div>

        <div style={{ fontSize: 20, color: "#9CA3AF", lineHeight: 1.5, maxWidth: 700 }}>
