...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    num: "06",
    title: "Keept",
    type: "Personal project · Screen time",
    version: "React Native 0.86 · New Architecture · iOS & Android",
    summary:
    ...
    architecture: [
      { decision: "Turbo Module + platform native modules", rationale: "One JS contract; Android service/overlay and iOS Screen Time extensions implement enforcement" },
      { decision: "Zustand + MMKV multi-process", rationale: "JS and native monitor share limits and usage without a server" },
      { decision: "Feature folders + domain layer", rationale: "Screens, hooks, and permission/catalog logic stay testable and platform-split via `.ios`/`.android` modules" },
    ],
    tradeoffs: [
      { chosen: "Turbo Modules over legacy bridge", rationale: "New Architecture codegen for `NativeUsageStats`; one legacy bridge remains for Android theme sync" },
      { chosen: "On-device only over cloud accounts", rationale: "Privacy-first product — no sync infrastructure to build or operate" },
    ],
    performanceNotes: [
